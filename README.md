...
> **설치 커맨드** (`/dev-workflow:setup`)는 [Installation](#installation)을 참조하세요. 1.8.0부터 `.claude/rules/` 디렉토리 초기화 옵션이 추가되었습니다. 1.9.0부터 결정 흐름 단계화(한 번에 하나씩, 의존성 발견 시 그룹핑, 충돌 시 재논의 대기열)가 도입되었습니다.
